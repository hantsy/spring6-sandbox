...
public class JdbcTemplateTest {
    ...
    public void testSaveAllAndQuery() {
        ...
        var result = this.template.query(sqlQueryAll, (rs, rowNum) -> Post.of(rs.getString("title"), rs.getString("content")));
    ...
    public void testSaveAndQuery() {
        ...
        var result = this.template.queryForObject(
                sqlQuery,
                (rs, rowNum) -> Post.of(rs.getString("title"), rs.getString("content")),
                id);
