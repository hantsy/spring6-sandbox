...
import com.example.demo.domain.HibernateConfig;
 ...
 */
@Slf4j
@SpringJUnitConfig(classes = {DataSourceConfig.class, HibernateConfig.class, PostRepositoryTestWithTestcontainers.TestConfig.class})
